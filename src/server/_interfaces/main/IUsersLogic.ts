...
export interface IUsersLogic {
    ...
    addChangeRoleAsync(role: RoleDto): Promise<IDatabaseResult<RoleDto>>;
    getRoleListAsync(): Promise<IDatabaseResult<RoleDto[]>>
    deleteRolesAsync(ids: number[]): Promise<IDatabaseResult<number>>;
