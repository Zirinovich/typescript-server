                                            ...
                                            <nav>
                                                <ul className="nav navbar-nav">
                                                    <li className="dropdown">
                                                        <Link to="/" className="dropdown-toggle active">Home</Link>
                                                    </li>
                                                    <li className="dropdown yamm-fw">
                                                        <a href="message-boxes.html" className="dropdown-toggle">Elements</a>
                                                                    ...
                                                                    <div className="row">
                                                                        <ul className="col-sm-6 col-md-3 list-unstyled ">
                                                                            ...
                                                                            <li><a href="accordions.html"><i
                                                                                ...
                                                                                &nbsp; Accordions</a></li>
                                                                            <li><a href="image-hover.html"><i
                                                                                className="fa fa-picture-o"></i>
                                                                                &nbsp; Image Hovers</a></li>
                                                                            ...
                                                                            <li><a href="call-to-action.html"><i
                                                                                ...
                                                                                &nbsp; Call to Action</a></li>
                                                                            <li><a href="carousel-sliders.html"><i
                                                                        ...
                                                                        <ul className="col-sm-6 col-md-3 list-unstyled ">
                                                                            ...
                                                                            <li><a href="columns.html"><i
                                                                                className="fa fa-leaf"></i>
                                                                                &nbsp; Columns</a></li>
                                                                            <li><a href="lists.html"><i
                                                                                className="fa fa-list"></i>
                                                                                &nbsp; lists Styles</a>
                                                                            </li>
                                                                            <li><a href="message-boxes.html"><i
                                                                                className="fa fa-tags"></i>
                                                                                &nbsp; Message Boxes</a></li>
                                                                            <li><a href="parallax-backgrounds.html"><i
                                                                                className="fa fa-cloud"></i>
                                                                                &nbsp; Parallax Backgrounds</a></li>
                                                                            <li><a href="pricing-tables.html"><i
                                                                                className="fa fa-rocket"></i>
                                                                                &nbsp; Pricing Tables</a></li>
                                                                        </ul>
                                                                        <ul className="col-sm-6 col-md-3 list-unstyled ">
                                                                            <li>
                                                                            ...
                                                                            <li><a href="typography.html"><i
                                                                                className="fa fa-font"></i>
                                                                                &nbsp; Typography</a>
                                                                            </li>
                                                                            <li><a href="content-boxes.html"><i
                                                                                className="fa fa-flag"></i>
                                                                                &nbsp; Content Boxes</a></li>
                                                                            <li><a href="data-tables.html"><i
                                                                        ...
                                                                        <ul className="col-sm-6 col-md-3 list-unstyled ">
                                                                            ...
                                                                            <li><a href="icon-boxes.html"><i
                                                                                ...
                                                                                &nbsp; Icon Boxes</a></li>
                                                                            <li><a href="team-member.html"><i
                                                                                className="fa fa-user"></i>
                                                                                &nbsp; Team member</a></li>
                                                                            <li><a href="latest-posts.html"><i
                                                                                className="fa fa-thumbs-up"></i>
                                                                                &nbsp; Latest Posts</a></li>
                                                                            <li><a href="dividers.html"><i
                                                    ...
                                                    <li className="dropdown"><a href="about.html"
